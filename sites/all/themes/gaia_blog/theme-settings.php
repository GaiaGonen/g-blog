 ...
 */
function gaia_blog_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['gaia_blog_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('gaia_blog sample setting'),
  '#default_value' => theme_get_setting('gaia_blog_example'),
