 ...
 */
function g_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['g_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('g_theme sample setting'),
  '#default_value' => theme_get_setting('g_theme_example'),
